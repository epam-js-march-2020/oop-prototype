# Homework #3 OOP, prototype inheritance
## Deadline 10/05
...
Необходимо написать программу, для расчета стоимости и каллорийности заказа посетителя.
...
**Управление**  
Реализовать управление возможно двумя способами - консоль или DOM-элементы.
Консоль. Для работы с меню в консоли необходимо реализовать API приложения, с помощью которого будет удобно производить основные операции: создание нового заказа, добавление в него позиций меню, удаление позиций, подсчет общего количества стоимости/каллорий, оплата заказа.
DOM-преставление. В случае реализации приложения с помощью верстки так же необходимо добавить требуемый набор кнопок для управления заказом. Варианты верстки на личное усмотрение каждого - минимальный необходимый набор функционала, либо же интересное оформление с иконами и модалками. 
